...
public class UiGridProducts {
    ...
    @JsonCreator
    public UiGridProducts(@JsonProperty("reference") String reference) {
        super();
        this.reference = reference;
    }


    public UiGridProducts(String reference, String description) {
        super();
        this.reference = reference;
        this.description = description;
    }

    public UiGridProducts(String reference, String description, int quantity, Double discount, Double unitPrice) {
        super();
        this.reference = reference;
    ...
    public UiGridProducts(String reference, String description, int quantity, Double unitPrice) {
